...
const CompaniaPage = ({handleRedirect,idCompania1})=>{
    ...
    return(
        <div>
            <Table title={"Compañias"} nameColumnsD={nameColumnsDisplay} nameColumnsK={nameColumnsKeys} items={compania} handleState={handleState} handleFetchDataByID={handleFetchDataByID} abrirForm={abrirForm} titleForm={"Registrar Compania"} handleRedirect={handleRedirect} idCompania={idCompania1}/>
